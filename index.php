        ...
        <div id="main" role="main">
          <div id="slider_events">
            ...
            <div id="events">
              ...
              <h4 class="side_slider"><a href="/products">Cobalt Talon: <br>Knowledge Engine for Healthcare</a></h4>
              <p>Knowledge Engine for healthcare enables healthcare payers with capabilities such as cost and quality of care analytics, predictive risk management, “propensity to buy” models, provider performance monitoring, and much, much more.   <a href="/products">Read More</a></p>
            </div>
          </div>
          <div id="break"></div>
          <div id="modules">
