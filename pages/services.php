      ...
      <div id="main" role="main">
        ...
        <div class="content">
          ...
          <div class="customer_benefits_list text_with_image">
            ...
            <ul>
              ...
              <li id="customer_benefits4" class="acc_class"><a href="#" class="acc_link">Pay as You Go Model</a>
                <div class="acc_text">
                  <strong><em>Pay-as-you-go</em> payment model</strong> <strong>for analytics software &amp; solutions</strong> delivered as a service
                  <ul>
              ...
              <li id="customer_benefits5" class="acc_class"><a href="#" class="acc_link">Reduced Implementation Risk in Rolling Out</a>
                <div class="acc_text">
                  Dramatically<strong> reduced implementation risk in rolling out</strong> analytics, business intelligence, and data warehousing solutions relative to “rolling your own”
                  <ul>
              ...
              <li id="customer_benefits6" class="acc_class"><a href="#" class="acc_link">Able to Focus on Your Core Business</a>
                <div class="acc_text">
                  Enables your firm to stay <strong>focused on your core business</strong>, while leveraging world-class Analytics solutions and resources to solve complex and complicated business problems
                </div>
              </li>
            </ul>
          </div>
          <div class="acc_class">
            ...
            <p><a class="acc_link" href="/services/implementation">Read More</a></p>
          </div>
