        ...
        <div id="main" role="main">
          <div class="left_col">
            <div class="menu local">
              <?php include '../partials/_services_menu.php'; ?></div>
          </div>
          <div class="content">
            ...
            <!--Customer Benefits-->
            <div class="customer_benefits_list text_with_image">
              <h2 id="customer_benefits"><a class="acc_link" href="#"></a>Customer Benefits</h2>
              <div class="customer_benefits_micro"><img src="/images/services/micro.jpg"> Enterprise data with MicroStrategy Mobile.</div>
          ...
          <div class="right_col">
            ...
            <div class="action">
              ...
              <a class="fancy" href="/contact#contact">Check It Out</a></div>
            </div>
          </div>
        </div>
