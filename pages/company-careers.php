    ...
    <div id="wrapper">
      <div id="container">
        ...
        <div id="main" role="main">
          <div class="left_col">
            <?php
            include '../partials/_company_menu.php';
            ?>
          </div>
          <div class="content">
            <h1>Company</h1>
