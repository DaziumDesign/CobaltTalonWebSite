      ...
      <div id="container">
        ...
        <div id="main" role="main">
          ...
          <div class="content">
            ...
            <ul>
              <li>Top-notch People – Experts who understand how to turn data into actionable knowledge and how to put all of the technology pieces together for seamless access by the end-user</li>  
              <li>World-Class Technology – Teradata provides a powerful, scalable, and reliable analytic database platform and MicroStrategy, a global leader in business intelligence is the platform for data analysis, reports and dashboards, data mining, forecasting, via web and mobile</li> 
            ...
            <ul>
              <li>Improve health outcomes and reducing cost to customers</li> 
              <li>Proactive management of medical loss ratios and risk adjustors (healthcare reform regs)</li>
              <li>Early identification of health risks without traditional underwriting processes</li> 
              <li>Patient centered medical homes and accountable care organization reporting and analysis</li>
              <li>Proving return on investment for health and wellness solutions</li>
              <li>Consumer segmentation and target market opportunities</li>
              <li>Exploration of diversification strategies and associated marketing campaigns</li>
            </ul>
          </div>
