      ...
      <div id="container">
        ...
        <div id="main" role="main">
          ...
          <div id="content">
            ...
            <h2 id="market-shift-module-analytic-platform" name="market-shift-module-analytic-platform">Market Shift&trade; Analytic Platform</h2>
            <p>We help turn data into actionable information. Let the Market-Shift Analytic Platform help you acquire new customers, deepen relationships with existing customers, strengthen distribution channels, facilitate channel choice, differentiate your brand and link targeted marketing investments to business results.</p>

            <h2>End-to-End Capabilities</h2>
            <p><a data-popup href="/images/products/products-market-shift-analytic-platform-lg.jpg?v=20130423"><img src="/images/products/products-market-shift-analytic-platform-sm.jpg?v=20130423" width="590" height="409" alt="Market Shift Analytic Platform" /></a><br><em>Click image for larger view</em></p>
          </div>
