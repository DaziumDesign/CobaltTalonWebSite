          ...
          <div id="content-nosidebars">
            <div class="lgray padded">
              ...
              <dl>
                ...
                <dt>Actionable Intelligence</dt>
                <dd>Any intelligence that can be used to boost a company's strategic position against industry peers. The acquired intelligence must be transferred into real actions that can be used to either launch a preemptive strike or prepare a counter strategy.</dd>
                ...
                <dd>The ability of an HIE to share data from within an EHR system.</dd>
                <dt>Patient-Centered Medical Home (PCMH)</dt>
                <dd>An approach to transforming the organization and delivery of primary care. Relationship-based primary care that meets the individual patient and family’s needs, preferences, and priorities.</dd>
                <dt>Population Health Management</dt>
                <dd>An approach to healthcare that aims to improve the health of everyone in a clinical practice.  Driven by increasing use of population based process and performance improvement measures, population health management relies on the ability to provide patient support between clinical visits, and to enhance clinical decision support for more comprehensive care delivery during a clinical visit.</dd>
                <dt>Shared Savings Program</dt>
                <dd>Designed to facilitate coordination and cooperation among providers to improve the quality of care for Medicare Fee-For-Service (FFS) beneficiaries and reduce unnecessary costs. Eligible providers, hospitals, and suppliers may participate in the Shared Savings Program by creating or participating in an Accountable Care Organization (ACO).</dd>
              </dl>
            </div>
          </div>
        </div>
